  ...
  \*****************************************************/
            ...
            /***/ function(module, exports) {
                ...
                windowRef.AudioBufferSourceNode =
                    windowRef.AudioBufferSourceNode || function() {};
                ...
                if (
                    windowRef.AnalyserNode &&
                    !windowRef.AnalyserNode.prototype.getFloatTimeDomainData
                ) {
                    windowRef.AnalyserNode.prototype.getFloatTimeDomainData = function(
                        array,
                    ) {
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                (function(factory) {
                    ...
                    const Zone$1 = (function(global) {
                        ...
                        class Zone {
                            constructor(parent, zoneSpec) {
                                this._parent = parent;
                                this._name = zoneSpec
                                    ? zoneSpec.name || 'unnamed'
                                    : '<root>';
                                this._properties =
                                    (zoneSpec && zoneSpec.properties) || {};
                        ...
                        class ZoneDelegate {
                            constructor(zone, parentDelegate, zoneSpec) {
                                ...
                                if (zoneSpecHasTask || parentHasTask) {
                                    ...
                                    this._hasTaskZS = zoneSpecHasTask
                                        ? zoneSpec
                                        : DELEGATE_ZS;
                            ...
                            if (
                                ...
                                if (!nativeMicroTaskQueuePromise) {
                                    if (global[symbolPromise]) {
                                        nativeMicroTaskQueuePromise = global[
                                            symbolPromise
                                        ].resolve(0);
                                    }
                                }
                        ...
                        const _api = {
                            ...
                            setNativePromise: NativePromise => {
                                ...
                                if (
                                    ...
                                    nativeMicroTaskQueuePromise = NativePromise.resolve(
                                        0,
                                    );
                                }
                            },
                    ...
                    Zone.__load_patch('ZoneAwarePromise', (global, Zone, api) => {
                                ...
                                if (
                                    ...
                                    if (promise[symbolFinally] === symbolFinally) {
                                        ...
                                        if (state === RESOLVED) {
                                            ...
                                            promise[symbolState] =
                                                promise[symbolParentPromiseState];
                                            promise[symbolValue] =
                                                promise[symbolParentPromiseValue];
                                        }
                                    }
                        ...
                        function patchThen(Ctor) {
                            ...
                            Ctor.prototype.then = function(onResolve, onReject) {
                                const wrapped = new ZoneAwarePromise(
                                    (resolve, reject) => {
                    ...
                    const wrapFn = function(event) {
                        ...
                        if (!eventNameSymbol) {
                            eventNameSymbol = zoneSymbolEventNames[
                                event.type
                            ...
                            if (typeof this === 'function') {
                                ...
                                if (originalDelegate) {
                                    if (typeof originalDelegate === 'function') {
                                        return originalFunctionToString.call(
                                            originalDelegate,
                                        );
                                    } else {
                    ...
                    function patchEventTarget(_global, apis, patchOptions) {
                            ...
                            if (tasks) {
                                ...
                                if (tasks.length === 1) {
                                    ...
                                    for (let i = 0; i < copyTasks.length; i++) {
                                        if (
                                            event &&
                                            event[IMMEDIATE_PROPAGATION_SYMBOL] === true
                                        ) {
                                            break;
                                        }
                        ...
                        function patchEventTargetMethods(obj, patchOptions) {
                            ...
                            const customCancelGlobal = function(task) {
                                ...
                                if (!task.isRemoved) {
                                    ...
                                    if (symbolEventNames) {
                                        symbolEventName =
                                            symbolEventNames[
                                                task.capture ? TRUE_STR : FALSE_STR
                                            ];
                                    }
                                    const existingTasks =
                            ...
                            const compareTaskCallbackVsDelegate = function(
                                task,
                                delegate,
                            ) {
                            ...
                            proto[REMOVE_ALL_LISTENERS_EVENT_LISTENER] = function() {
                                ...
                                if (!eventName) {
                                    ...
                                    if (symbolEventNames) {
                                        const symbolEventName =
                                            symbolEventNames[FALSE_STR];
                                        const symbolCaptureEventName =
                                            symbolEventNames[TRUE_STR];
                                        const tasks = target[symbolEventName];
                                        const captureTasks =
                                            target[symbolCaptureEventName];
                                        if (tasks) {
                    ...
                    Zone.__load_patch('util', (global, Zone, api) => {
                        ...
                        const SYMBOL_UNPATCHED_EVENTS = Zone.__symbol__(
                            'UNPATCHED_EVENTS',
                        );
                        ...
                        if (global[SYMBOL_BLACK_LISTED_EVENTS]) {
                            Zone[SYMBOL_BLACK_LISTED_EVENTS] = Zone[
                    ...
                    Zone.__load_patch('XHR', (global, Zone) => {
                        ...
                        function patchXHR(window) {
                            ...
                            function scheduleTask(task) {
                                ...
                                if (!oriAddListener) {
                                    oriAddListener =
                                        target[ZONE_SYMBOL_ADD_EVENT_LISTENER];
                                    oriRemoveListener =
                                        target[ZONE_SYMBOL_REMOVE_EVENT_LISTENER];
                                }
                                if (listener) {
                                    oriRemoveListener.call(
                                        target,
                                        READY_STATE_CHANGE,
                                        listener,
                                    );
                                ...
                                () =>
                                    function(self, args) {
                                        ...
                                        if (self[XHR_SYNC]) {
                                            ...
                                            if (
                                                self &&
                                                self[XHR_ERROR_BEFORE_SCHEDULED] ===
                                                    true &&
                                                !options.aborted &&
                                                task.state === SCHEDULED
                                            ) {
  ...
  \********************************/
            ...
            /***/ function(module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! C:\Users\a.inkin\WebstormProjects\ng-web-apis.github.io\src\polyfills.ts */ './src/polyfills.ts',
                );
